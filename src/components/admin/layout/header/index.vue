  ...
  <div id="admin">
    <header class="header">
      <div class="logo">
        ...
        <div v-if="showToggleBtn" @click="toggleSide" class="side-toggle">
          <Tooltip content="显示/隐藏侧边栏">
            <Icon type="md-list"/>
          </Tooltip>
        </div>
      </div>
      <ul class="header-tags">
        <li class="tag-item">
          <Poptip word-wrap width="300">
            ...
            <div slot="content">
              <div class="header-list-title">您有<span style="color:red"> 5 </span>条提醒</div>
        ...
        <li class="tag-item">
          <Poptip word-wrap width="300">
            ...
            <div slot="content">
              <div class="header-list-title">您有<span style="color:green"> 5 </span>条新消息</div>
              <a class="header-list">要么活着死，要么死着生，风萧萧兮易水寒，壮士一去兮不复还。
